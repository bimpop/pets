...
public class EditorActivity extends Activity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		// in order to determine if we're creating a new pet or editing an existing one
		...
		// Instantiate db PetDbHelper class
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                savePet();
				// close the Activity, implies returning to CatalogActivity
				// (parent activity)
				finish();
                return true;
